...
const SearchCard = ({ type, information }) => {
  return (
    <motion.div
      className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 p-6 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:hover:border-gray-600 dark:border-gray-700"
      role="listitem"
      initial={{ opacity: 0 }}
